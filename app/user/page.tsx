      ...
      return (
        <div>
          ...
          <div className="border border-black w-1/2 px-4">
            <div className="my-4">
              address <i className="fa fa-chevron-right float-end fa-2x"></i>
            </div>
            <div className="my-4">
              email <i className="fa fa-chevron-right float-end fa-2x"></i>
            </div>
            <div className="my-4">
              phone <i className="fa fa-chevron-right float-end fa-2x"></i>
            </div>
            <div className="my-4">
              change password{" "}
              <i className="fa fa-chevron-right float-end fa-2x"></i>
            </div>
          </div>
          <div className="my-4">
